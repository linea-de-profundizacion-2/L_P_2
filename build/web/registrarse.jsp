                ...
                <div class="col-12 user-img">
                  ...
                  <form class="col-12" method="post" action="control_reg">
  				 ...
  				 <div class="form-group  ">
                           ...
                           <br>
                                 <input type="text" name="usuario"class="form-control " id="usu" placeholder="Usuario" required autocomplete="off">
 				 </div>
                      
                                  <div class="form-group  ">
  				
                                 <input type="text" name="nombre" class="form-control " id="nom1" placeholder="Nombre " required autocomplete="off">
 				</div>
                      
                                  <div class="form-group  ">
                                
                                <input type="text" name="apellido"class="form-control" id="APEL" placeholder="Apellido" required autocomplete="off">
                                </div>
