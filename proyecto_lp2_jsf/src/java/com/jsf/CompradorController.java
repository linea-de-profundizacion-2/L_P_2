...
import com.sessionsBean.CompradorFacade;
...
public class CompradorController implements Serializable {
    ...
    @EJB
    private CompradorFacade ejbFacade;
    ...
    public Comprador getComprador(java.lang.Integer id) {
    ...
    public static class CompradorControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getComprador(getKey(value));
        }
